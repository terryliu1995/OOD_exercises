...
2. abstract State implement State

3. Noselection extend AbstractState

4. HasSelectionState  extend AbstractState

5. InsertedMoneyState extend AbstractState
*/


class VendingMachineQuestion {
